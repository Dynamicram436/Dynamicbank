...
t1 = train('Korba', 12345, '12:34', '22:12', 'Vijayawada', 'Durg','Wed', 30,23,43,2205,320,234)
t2 = train('Durg', 12565, '02:34', '23:12', 'Vijayawada', 'Nagpur', 'Mon',33,4,12,3434,435,234)
t3 = train('Vijayawada', 22353, '11:56', '03:12','Chennai','Vijayawada', 'Fri', 33,24,77,455,325,533)
trains = {t1.num:t1,t2.num:t2,t3.num:t3}
u1 = user(1111, 'Bhargavram', 'cuttack', '7478021777', 'Bhargavram')
u2 = user(2322, 'Anudeep', 'newyork', '7873752967','Anudeep')
users = {u1.uid : u1 , u2.uid : u2}
ticket_dict = {}

def load():
    global  trains,user,ticket_dict
